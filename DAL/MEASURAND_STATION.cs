...
namespace Maticsoft.DAL
{
	...
	public partial class MEASURAND_STATION
	{
		...
		public bool Add(Maticsoft.Model.MEASURAND_STATION model)
		{
			...
			strSql.Append("id,station_name,state,posx,posy,dynamic,procince_city,river_id,comments)");
		...
		public bool Update(Maticsoft.Model.MEASURAND_STATION model)
		{
			...
			parameters[2].Value = model.posx;
			parameters[3].Value = model.posy;
			parameters[4].Value = model.dynamic;
			parameters[5].Value = model.procince_city;
			parameters[6].Value = model.river_id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.MEASURAND_STATION GetModel(long id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,station_name,state,posx,posy,dynamic,procince_city,river_id,comments from MEASURAND_STATION ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt,8)			};
			parameters[0].Value = id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,station_name,state,posx,posy,dynamic,procince_city,river_id,comments ");
